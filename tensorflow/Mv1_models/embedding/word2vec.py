...
flags.DEFINE_string("save_path", './logs', "Directory to write the model and "
                    "training summaries.")
flags.DEFINE_string("train_data", 'http://mattmahoney.net/dc/text8.zip', "Training text file. "
